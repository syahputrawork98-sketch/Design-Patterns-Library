# Root Governance: Design-Patterns-Library

Dokumen ini memuat aturan tingkat root untuk monorepo **Design Patterns Library**.
...
- `.cursorrules`: Sebagai hukum interaksi AI khusus Design Patterns.
...
- Konvensi penomoran & AI Persona (Software Design Patterns Purist).
